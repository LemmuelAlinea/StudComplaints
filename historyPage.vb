...
Public Class historyPage
    ...
    Private Sub saveBtn_Click(sender As Object, e As EventArgs) Handles saveBtn.Click
        ...
        For Each row As DataGridViewRow In historyTbl.Rows
    ...
    Private Sub viewBtn_Click(sender As Object, e As EventArgs) Handles viewBtn.Click
        Dim connectionString As String = "Server=localhost;Database=studentscomplaints;Uid=root;Pwd=Yoyopogi2005;"
        Dim query As String = "SELECT * FROM complaints WHERE status = 'finished'"
        ...
        Using connection As New MySqlConnection(connectionString)
            Try
                ...
                historyTbl.DataSource = dataTable
            Catch ex As Exception
    ...
    Private Sub adHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub deleteBtn_Click(sender As Object, e As EventArgs) Handles deleteBtn.Click
        ...
        Try
            ...
            Dim selectedRow As DataGridViewRow = historyTbl.SelectedRows(0) ' Only the first selected row
